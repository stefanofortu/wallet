...
class CategoryStructure:
    categories = {"Cibo & Bevande": ["Bar&Caffè", "Lunch", "Spesa"],
                  "Shopping": ["Abbigliamento", "Electronics", "Gifts"],
                  "Home": ["Affitto/Mutuo", "Utenze", "Family", "Furniture, Maintenance"],
                  ...
                  "Investimenti": ["Education", "Work", "Immobili", "Education_New", "Work_New"],
